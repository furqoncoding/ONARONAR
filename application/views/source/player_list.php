												...
												<td>
                                                    ...
                                                    <div class="btn-group mr-1 mb-1 ">
                                                        ...
                                                        <div class="dropdown-menu btn-sm">
                                                            <a class="dropdown-item" href="<?php echo base_url().'index.php/source/read/'.$data->id ?>">Read</a>
                                                            <a class="dropdown-item" href="<?php echo base_url().'index.php/source/update/'.$data->id ?>">Update</a>
                                                            <div class="dropdown-divider"></div>
                                                            <a class="dropdown-item" onclick='return confirm("Are you sure?");' href="<?php echo base_url().'index.php/source/delete/'.$data->id ?>">Delete</a>
														</div>
													</div>
