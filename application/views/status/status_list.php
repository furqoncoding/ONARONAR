						...
						<div class="card-body card-dashboard">
							...
							<div class="table-responsive">
								<table class="table table-striped table-bordered zero-configuration">
									<thead>
										<tr>
											<th style="width:70%">Status_Name</th>
											<th>Status</th>
											<th></th>
										</tr>
									</thead>
												...
												<td>
                                                    ...
                                                    <div class="btn-group mr-1 mb-1 ">
                                                        ...
                                                        <div class="dropdown-menu btn-sm">
                                                            <a class="dropdown-item" href="<?php echo base_url().'index.php/status/read/'.$data->id ?>">Read</a>
                                                            <a class="dropdown-item" href="<?php echo base_url().'index.php/status/update/'.$data->id ?>">Update</a>
                                                            <div class="dropdown-divider"></div>
                                                            <a class="dropdown-item" onclick='return confirm("Are you sure?");' href="<?php echo base_url().'index.php/status/delete/'.$data->id ?>">Delete</a>
															</div>
													</div>	
												</td>
											</tr>
