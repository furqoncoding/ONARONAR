<?php
	...
	class Onairchief extends CI_Controller
	{
		...
		public function index()
		{
			...
			'icon' => 'onairchief',
			'create' => base_url().'index.php/onairchief/create',
			'row' => $this->Onairchief_model->get_all(),
			);
			
			$this->template->main('onairchief/onairchief_list', $data);
		...
		public function read($id) 
		{
			...
			if ($row) {
				...
				'button' => 'Update',
				'action' => base_url().'index.php/onairchief/update_action',
				);
				
				
				$this->template->main('onairchief/onairchief_form_read', $data);
			}
			else {
				
				$this->session->set_flashdata('error', 'No Record Found');
				redirect('onairchief', 'refresh');
			}
		...
		public function create() 
		{
			...
			'button' => 'Create',
			'action' => base_url().'index.php/onairchief/create_action',
			);
			
			
			$this->template->main('onairchief/onairchief_form', $data);
