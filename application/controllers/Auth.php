	...
	class Auth extends CI_Controller
	{
		...
		*/
		public function index()
		{
			...
			else
			{
				...
				$this->data['menu']=$this->multi_menu->render('setting');
				...
				$this->template->main('auth' . DIRECTORY_SEPARATOR . 'index', $this->data);
		...
		*/
		public function deactivate($id = NULL)
		{
			...
			$this->template->main('auth' . DIRECTORY_SEPARATOR . 'deactivate_user', $this->data);
		...
		*/
		public function create_user()
		{
			...
			else
			{
				...
				$this->template->main('auth' . DIRECTORY_SEPARATOR . 'create_user', $this->data);
		...
		*/
		...
		/**
			...
			* @param int|string $id
		*/
		public function edit_user($idd)
		{
		
			$id=$this->globalfunction->decodehid($idd);
			...
			$this->template->main('auth' . DIRECTORY_SEPARATOR . 'edit_user', $this->data);
