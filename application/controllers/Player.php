<?php
	...
	class Player extends CI_Controller
	{
		...
		public function index()
		{
			...
			'icon' => 'player',
			'create' => base_url().'index.php/player/create',
			'row' => $this->Player_model->get_all(),
			);
			
			$this->template->main('player/player_list', $data);
		...
		public function read($id) 
		{
			...
			if ($row) {
				...
				'button' => 'Update',
				'action' => base_url().'index.php/player/update_action',
				);
				
				
				$this->template->main('player/player_form_read', $data);
			}
			else {
		...
		public function create() 
		{
			...
			'button' => 'Create',
			'action' => base_url().'index.php/player/create_action',
			);
			
			
			$this->template->main('player/player_form', $data);
