<?php
	...
	class Users extends CI_Controller
	{
		...
		public function index()
		{
			...
			'title' => strtoupper(str_replace('_',' ','Master Users')),
			'icon' => 'users',
			'create' => base_url().'index.php/users/create',
			'row' => $this->Users_model->get_all(),
			);
		...
		public function create_action() 
		{
			...
			if ($this->form_validation->run() == FALSE) {
				...
				//!die("tidak");
				//!die($this->input->post('engineer_name',TRUE));
				$data = array(
				'active' => $this->input->post('active',TRUE),
				'email' => $this->input->post('email',TRUE),
				);
				
				if($save = $this->Users_model->insert($data)) {
		...
		public function update_action() 
		{
			...
			if ($this->form_validation->run() == FALSE) {
				...
				if($update = $this->Users_model->update($data,$where)) {
		...
		public function delete($id) 
		{
			...
			if ($row) {
				...
				if($this->Users_model->delete($where)) {
